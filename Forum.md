...
## Run with Docker
1. Launch Docker Desktop or distro equivalent
2. docker-compose up --build (it takes a bit for better-sql to build so don't worry if no error messages appear)
3. Then visit [http://localhost:25034]

## Run without Docker
1. npm install
2. npx tsc
3. node dist/server.js
4. Then visit [http://localhost:25034]
